...
{viewerjumpto "Postestimation Syntax" "csdid##postestimation"}{...}
...
{viewerjumpto "Updates" "csdid##updates"}{...}
{viewerjumpto "Acknowledgements" "csdid##acknowledgements"}{...}
{viewerjumpto "References" "csdid##references"}{...}
{title:Title}

{p2colset 5 18 20 2}{...}
{p2col :{cmd:csdid} {hline 2}}Difference in differences with multiple time periods{p_end}
{p2colreset}{...}
...
{p 8 15 2} {cmd:csdid}
{depvar} [{indepvars}]
{ifin} {cmd:,} {opth ivar() time() treatment()} [{help csdid##options:options}] {p_end}
